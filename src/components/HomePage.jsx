...
return (
<div className={`${value.darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
       {/* Body Content */}
       <div className='ml-6'>
       <div className={`flex justify-between visible ${value.togValue ? 'visible':'invisible sm:visible'}`}>
         <div className={`flex items-center ${value.togValue ? 'ml-12' : 'ml-72'}`}>
     ...
     <div className={`mt-4 lg:h-[180px] grid grid-rows-3 md:grid-rows-3 lg:grid-cols-3 gap-4 pl-6 ${value.togValue ? 'ml-4 visible' : 'ml-64 invisible sm:visible'} mr-2`}>
       {data.map(item=>(
     ...
     <div className={`grid grid-rows-2 md:grid-rows-2 lg:grid-cols-2 gap-1 sm:gap-4 min-h-[150px] pl-6 mt-4 ${value.togValue ? 'ml-4 visible' : 'ml-64 invisible sm:visible'} mr-2`}>
       <div className={`min-w-[180px] h-[250px] lg:h-full rounded-md p-6 ${value.darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
         <Chart />
       </div>
       <div className={`min-w-[180px] h-[250px] lg:h-full rounded-md p-6 ${value.darkMode ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
         <PieChar />
