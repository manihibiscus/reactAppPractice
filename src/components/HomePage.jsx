...
export const HomePage = ({value, darkMode}) => {
  ...
  return (
    ...
    <div className={`grid grid-rows-2 md:grid-rows-2 lg:grid-cols-2 gap-4 min-h-[150px] pl-6 ${value ? 'ml-4 visible' : 'ml-64 invisible sm:visible'}`}>
      <div className={`bg-white min-w-[180px] lg:h-full rounded-md p-6`}>
        <Chart />
      </div>
      <div className={`bg-white min-w-[180px] lg:h-full rounded-md p-6`}>
        <PieChar />
